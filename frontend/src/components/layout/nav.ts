...
export const NAV_ITEMS: NavItem[] = [
  ...
  { label: "Index Explorer", to: "/index-explorer", icon: Calculator },
  ...
  { label: "Fare Prediction", to: "/predictions", icon: Brain },
  { label: "Festival Analysis", to: "/festivals", icon: PartyPopper },
